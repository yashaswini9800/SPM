...
$propic=md5($propic).time().$extension;
 ...
 $sql="update tblprojects set Picture=:pic where ID=:eid";
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-projects.php">Update Image</a></li>
...
{               ?>
                                <div class="form-group"><label for="company" class=" form-control-label">Student Name</label><input type="text" name="subjects" value="<?php  echo $row->Name;?>" class="form-control" id="subjects" readonly='true'></div>
